...
const Navbar = () => {
  ...
  return (
    <nav className="bg-white/50 border-gray-200 dark:bg-gray-900/50 dark:border-gray-700">
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        <a href="https://www.twitch.tv/lydevn" target='_blank'  rel="noopener noreferrer" className="flex items-center space-x-3 rtl:space-x-reverse">
          <img src={TwitchLogo} className="h-8" alt="Lyde Logo" />
        ...
        <div className={`${navOpen ? 'block' : 'hidden'} w-full md:block md:w-auto`} id="navbar-dropdown">
          <ul
            className="flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50
                       ...
                       dark:bg-gray-800 md:dark:bg-gray-900/0 dark:border-gray-700"
          >
            <li>
              <a
                href="/"
              ...
              {dropdownOpen && (
                ...
                >
                  <ul className="py-2 text-sm text-gray-700 dark:text-gray-400">
                    <li>
                      <a href="/coucou" className="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">
                        Dashboard
                      </a>
                    </li>
                    <li>
